...
public class Change_PWActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Erepass1.setInputType(InputType.TYPE_TEXT_VARIATION_PASSWORD);
        Erepass1.setTransformationMethod(PasswordTransformationMethod.getInstance());
        Erepass2.setInputType(InputType.TYPE_TEXT_VARIATION_PASSWORD);
        Erepass2.setTransformationMethod(PasswordTransformationMethod.getInstance());

        Erepass1.getBackground().setColorFilter(getResources().getColor(R.color.color_bolder), PorterDuff.Mode.SRC_ATOP);
        Erepass2.getBackground().setColorFilter(getResources().getColor(R.color.color_bolder), PorterDuff.Mode.SRC_ATOP);
        ...
        Erepass1.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if((Erepass1.getText().toString()).equals(Erepass2.getText().toString())
                        &&Erepass1.getText().toString().length()!=0){
                ...
                if(Erepass1.getText().toString().length()==0)
                {
                    Trepasserror1.setText("");
                    Erepass1.setCompoundDrawablesWithIntrinsicBounds(null,null,null,null);
                    Erepass1.getBackground().setColorFilter(getResources().getColor(R.color.color_bolder),PorterDuff.Mode.SRC_ATOP);
                }
                if(Erepass2.getText().toString().length()==0)
                {
                    Trepasserror2.setText("");
                    Erepass2.setCompoundDrawablesWithIntrinsicBounds(null,null,null,null);
                    Erepass2.getBackground().setColorFilter(getResources().getColor(R.color.color_bolder),PorterDuff.Mode.SRC_ATOP);
                }
            }
        ...
        Erepass2.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
